...
from supplier.forms.suppliers_form import SupplierForm
...
class AddSupplier(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        return render(request, 'supplier/add_suppliers.html', {'form': SupplierForm()})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return render(request, 'supplier/add_suppliers.html', {'form': form})
